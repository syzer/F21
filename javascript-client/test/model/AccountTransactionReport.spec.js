...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwissCorporateApi.AccountTransactionReport();
  });
  ...
  describe('AccountTransactionReport', function() {
    it('should create an instance of AccountTransactionReport', function() {
      // uncomment below and update the code to test AccountTransactionReport
      //var instance = new SwissCorporateApi.AccountTransactionReport();
      //expect(instance).to.be.a(SwissCorporateApi.AccountTransactionReport);
    });
