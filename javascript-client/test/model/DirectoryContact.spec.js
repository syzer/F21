...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwissCorporateApi.DirectoryContact();
  });
  ...
  describe('DirectoryContact', function() {
    it('should create an instance of DirectoryContact', function() {
      // uncomment below and update the code to test DirectoryContact
      //var instance = new SwissCorporateApi.DirectoryContact();
      //expect(instance).to.be.a(SwissCorporateApi.DirectoryContact);
    });
