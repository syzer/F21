...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwissCorporateApi.AccountTransactionCounterparty();
  });
  ...
  describe('AccountTransactionCounterparty', function() {
    it('should create an instance of AccountTransactionCounterparty', function() {
      // uncomment below and update the code to test AccountTransactionCounterparty
      //var instance = new SwissCorporateApi.AccountTransactionCounterparty();
      //expect(instance).to.be.a(SwissCorporateApi.AccountTransactionCounterparty);
    });
