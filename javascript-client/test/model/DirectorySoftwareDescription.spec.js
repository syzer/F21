...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwissCorporateApi.DirectorySoftwareDescription();
  });
  ...
  describe('DirectorySoftwareDescription', function() {
    it('should create an instance of DirectorySoftwareDescription', function() {
      // uncomment below and update the code to test DirectorySoftwareDescription
      //var instance = new SwissCorporateApi.DirectorySoftwareDescription();
      //expect(instance).to.be.a(SwissCorporateApi.DirectorySoftwareDescription);
    });
    ...
    it('should have the property productInfoUrl (base name: "productInfoUrl")', function() {
      // uncomment below and update the code to test the property productInfoUrl
      //var instance = new SwissCorporateApi.DirectorySoftwareDescription();
      //expect(instance).to.be();
    });

    it('should have the property productLogo (base name: "productLogo")', function() {
      // uncomment below and update the code to test the property productLogo
      //var instance = new SwissCorporateApi.DirectorySoftwareDescription();
      //expect(instance).to.be();
    });
