...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwissCorporateApi.DirectoryMultisizeImageReference();
  });
  ...
  describe('DirectoryMultisizeImageReference', function() {
    it('should create an instance of DirectoryMultisizeImageReference', function() {
      // uncomment below and update the code to test DirectoryMultisizeImageReference
      //var instance = new SwissCorporateApi.DirectoryMultisizeImageReference();
      //expect(instance).to.be.a(SwissCorporateApi.DirectoryMultisizeImageReference);
    });
