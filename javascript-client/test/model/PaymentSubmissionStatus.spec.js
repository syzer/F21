...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwissCorporateApi.PaymentSubmissionStatus();
  });
  ...
  describe('PaymentSubmissionStatus', function() {
    it('should create an instance of PaymentSubmissionStatus', function() {
      // uncomment below and update the code to test PaymentSubmissionStatus
      //var instance = new SwissCorporateApi.PaymentSubmissionStatus();
      //expect(instance).to.be.a(SwissCorporateApi.PaymentSubmissionStatus);
    });
