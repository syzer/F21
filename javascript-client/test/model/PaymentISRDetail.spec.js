...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwissCorporateApi.PaymentISRDetail();
  });
  ...
  describe('PaymentISRDetail', function() {
    it('should create an instance of PaymentISRDetail', function() {
      // uncomment below and update the code to test PaymentISRDetail
      //var instance = new SwissCorporateApi.PaymentISRDetail();
      //expect(instance).to.be.a(SwissCorporateApi.PaymentISRDetail);
    });
