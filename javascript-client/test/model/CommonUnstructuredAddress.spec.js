...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwissCorporateApi.CommonUnstructuredAddress();
  });
  ...
  describe('CommonUnstructuredAddress', function() {
    it('should create an instance of CommonUnstructuredAddress', function() {
      // uncomment below and update the code to test CommonUnstructuredAddress
      //var instance = new SwissCorporateApi.CommonUnstructuredAddress();
      //expect(instance).to.be.a(SwissCorporateApi.CommonUnstructuredAddress);
    });
