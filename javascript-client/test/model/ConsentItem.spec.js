...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwissCorporateApi.ConsentItem();
  });
  ...
  describe('ConsentItem', function() {
    it('should create an instance of ConsentItem', function() {
      // uncomment below and update the code to test ConsentItem
      //var instance = new SwissCorporateApi.ConsentItem();
      //expect(instance).to.be.a(SwissCorporateApi.ConsentItem);
    });
