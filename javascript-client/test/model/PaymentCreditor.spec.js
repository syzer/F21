...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwissCorporateApi.PaymentCreditor();
  });
  ...
  describe('PaymentCreditor', function() {
    it('should create an instance of PaymentCreditor', function() {
      // uncomment below and update the code to test PaymentCreditor
      //var instance = new SwissCorporateApi.PaymentCreditor();
      //expect(instance).to.be.a(SwissCorporateApi.PaymentCreditor);
    });
