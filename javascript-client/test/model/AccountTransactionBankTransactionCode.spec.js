...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwissCorporateApi.AccountTransactionBankTransactionCode();
  });
  ...
  describe('AccountTransactionBankTransactionCode', function() {
    it('should create an instance of AccountTransactionBankTransactionCode', function() {
      // uncomment below and update the code to test AccountTransactionBankTransactionCode
      //var instance = new SwissCorporateApi.AccountTransactionBankTransactionCode();
      //expect(instance).to.be.a(SwissCorporateApi.AccountTransactionBankTransactionCode);
    });
