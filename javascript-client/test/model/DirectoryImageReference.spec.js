...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwissCorporateApi.DirectoryImageReference();
  });
  ...
  describe('DirectoryImageReference', function() {
    it('should create an instance of DirectoryImageReference', function() {
      // uncomment below and update the code to test DirectoryImageReference
      //var instance = new SwissCorporateApi.DirectoryImageReference();
      //expect(instance).to.be.a(SwissCorporateApi.DirectoryImageReference);
    });
