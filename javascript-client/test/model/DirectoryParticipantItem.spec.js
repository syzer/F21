...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwissCorporateApi.DirectoryParticipantItem();
  });
  ...
  describe('DirectoryParticipantItem', function() {
    it('should create an instance of DirectoryParticipantItem', function() {
      // uncomment below and update the code to test DirectoryParticipantItem
      //var instance = new SwissCorporateApi.DirectoryParticipantItem();
      //expect(instance).to.be.a(SwissCorporateApi.DirectoryParticipantItem);
    });
