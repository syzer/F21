...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwissCorporateApi.PaymentOtherAccount();
  });
  ...
  describe('PaymentOtherAccount', function() {
    it('should create an instance of PaymentOtherAccount', function() {
      // uncomment below and update the code to test PaymentOtherAccount
      //var instance = new SwissCorporateApi.PaymentOtherAccount();
      //expect(instance).to.be.a(SwissCorporateApi.PaymentOtherAccount);
    });
