...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwissCorporateApi.CommonErrorResponse();
  });
  ...
  describe('CommonErrorResponse', function() {
    it('should create an instance of CommonErrorResponse', function() {
      // uncomment below and update the code to test CommonErrorResponse
      //var instance = new SwissCorporateApi.CommonErrorResponse();
      //expect(instance).to.be.a(SwissCorporateApi.CommonErrorResponse);
    });
