...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwissCorporateApi.PaymentIbanAccount();
  });
  ...
  describe('PaymentIbanAccount', function() {
    it('should create an instance of PaymentIbanAccount', function() {
      // uncomment below and update the code to test PaymentIbanAccount
      //var instance = new SwissCorporateApi.PaymentIbanAccount();
      //expect(instance).to.be.a(SwissCorporateApi.PaymentIbanAccount);
    });
