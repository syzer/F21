...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwissCorporateApi.AccountBalanceItemLinks();
  });
  ...
  describe('AccountBalanceItemLinks', function() {
    it('should create an instance of AccountBalanceItemLinks', function() {
      // uncomment below and update the code to test AccountBalanceItemLinks
      //var instance = new SwissCorporateApi.AccountBalanceItemLinks();
      //expect(instance).to.be.a(SwissCorporateApi.AccountBalanceItemLinks);
    });
