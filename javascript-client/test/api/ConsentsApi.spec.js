...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwissCorporateApi.ConsentsApi();
  });
  ...
  describe('ConsentsApi', function() {
    describe('retrieveConsents', function() {
      it('should call retrieveConsents successfully', function(done) {
        //uncomment below and update the code to test retrieveConsents
        //instance.retrieveConsents(function(error) {
