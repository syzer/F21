...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwissCorporateApi.DiagnosticsApi();
  });
  ...
  describe('DiagnosticsApi', function() {
    ...
    describe('healthCheckPost', function() {
      it('should call healthCheckPost successfully', function(done) {
        //uncomment below and update the code to test healthCheckPost
        //instance.healthCheckPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
