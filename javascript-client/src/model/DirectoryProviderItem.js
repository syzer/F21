...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SwissCorporateApi.DirectoryProviderItem = factory(root.SwissCorporateApi.ApiClient, root.SwissCorporateApi.DirectoryContact, root.SwissCorporateApi.DirectoryImageReference, root.SwissCorporateApi.DirectoryMarketingDescription, root.SwissCorporateApi.DirectoryMultisizeImageReference, root.SwissCorporateApi.DirectoryParticipantStatus, root.SwissCorporateApi.DirectoryShortDescription, root.SwissCorporateApi.DirectorySoftwareDescription, root.SwissCorporateApi.DirectoryUseCaseItem);
  }
  ...
  /**
   * The DirectoryProviderItem model module.
   * @module model/DirectoryProviderItem
   * @version 1.0.0.2-SNAPSHOT
   */

  /**
   * Constructs a new <code>DirectoryProviderItem</code>.
   * @alias module:model/DirectoryProviderItem
   * @class
  ...
  /**
   * Constructs a <code>DirectoryProviderItem</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DirectoryProviderItem} obj Optional instance to populate.
   * @return {module:model/DirectoryProviderItem} The populated <code>DirectoryProviderItem</code> instance.
   */
