...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SwissCorporateApi.DirectoryShortDescription = factory(root.SwissCorporateApi.ApiClient);
  }
  ...
  /**
   * The DirectoryShortDescription model module.
   * @module model/DirectoryShortDescription
   * @version 1.0.0.2-SNAPSHOT
   */

  /**
   * Constructs a new <code>DirectoryShortDescription</code>.
   * @alias module:model/DirectoryShortDescription
   * @class
   * @param de {String} 
   * @param en {String} 
   * @param fr {String} 
  ...
  /**
   * Constructs a <code>DirectoryShortDescription</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DirectoryShortDescription} obj Optional instance to populate.
   * @return {module:model/DirectoryShortDescription} The populated <code>DirectoryShortDescription</code> instance.
   */
